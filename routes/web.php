...
Route::get('/course/{id}', function () {
    return view('clients.single-course');
});
...
Route::post('/send', 'OrderController@create')->name('create');

Auth::routes();

Route::middleware(['auth', 'master'])->group(function () {
    Route::get('/masters', 'MasterController@index')->name('masters.index');
    Route::get('/delete/{id}', 'MasterController@delete')->name('masters.delete');
    Route::get('/orders', 'MasterController@order')->name('masters.order');
    Route::get('/income', 'MasterController@display')->name('masters.income');
...
Route::middleware(['auth', 'master'])->group(function () {
    ...
    Route::get('school/remove/{school_id}', 'SchoolController@remove');
