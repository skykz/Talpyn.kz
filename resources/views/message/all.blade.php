    ...
    <div class="row">
        ...
        <div class="col-md-8" id="main-container">
            <div class="panel panel-default">
                <div class="page-panel-title">@lang('Сообщении')</div>
                                ...
                                <li class="notification">
                                    <div class="media">
                                        ...
                                        <strong class="notification-title"><a href="#">{{$message->teacher->name}}</a> . {{$message->teacher->department->department_name ?? null}}
                                            @if($message->active == 1)
                                                <span class="label label-danger">@lang('Новый')</span></strong>
                                            @else
                                                <span class="label label-default">@lang('Просмотрено')</span></strong>
                                            @endif
