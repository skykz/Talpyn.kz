        ...
        <div class="col-md-10" id="main-container">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="page-panel-title">@lang('Посмотреть список расходов')
{{--                <button class="btn btn-xs btn-success pull-right" role="button" id="btnPrint" >--}}
{{--                    <i class="material-icons">print</i> @lang('Распечатать этот список расходов')</button>--}}
              </div>
                    ...
                    <form class="form-horizontal" action="{{url('/accounts/list-expense')}}" method="post">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8">
                          <button type="submit" class="btn btn-danger">@lang('Получить список расходов')</button>
                        </div>
                      </div>
                    </form>
                </div>
            ...
            <div class="col-md-12">
              @isset($expenses)
                    <div class="table-responsive">
                      <table class="table table-data-div table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a title='Edit' class='btn btn-info btn-sm' href='{{url("accounts/edit-expense")}}/{{$expense->id}}'><i class="fas fa-edit"></i> @lang('Изменить')</a></td>
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
                      ...
                      <h4 style="text-align:center;">@lang('Список расходов')</h4>
...
$("#btnPrint").on("click", function () {
            ...
            printWindow.document.write('<html><head><title>@lang('Список расходов')</title>');
    ...
    <script>
		...
		var config = {
			...
			options: {
				title: {
                    display: true,
					text: @json( __('Расход (в тенге) в шкале времени'))
				},
