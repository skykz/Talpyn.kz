@extends('layouts.app')
@section('title', __('Добавить новый доход'))
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8" id="main-container">
            <div class="panel panel-default">
                <div class="page-panel-title">@lang('Добавить новый доход / Создать счет')</div>
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="{{url('accounts/create-income')}}" method="post">
                      ...
                      <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="amount" type="number" class="form-control" name="amount" value="{{ old('amount') }}" placeholder="@lang('Количество')" required>
                      ...
                      <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <textarea rows="3" id="description" class="form-control" name="description" placeholder="@lang('Описание')" required>{{ old('description') }}</textarea>
