...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10" id="main-container">
            <h2>@lang('Изменить данные курса')</h2>
            @if (session('status'))
            ...
            <div class="panel panel-default">
                <form class="form-horizontal" action="{{url('edit/course/'.$course->id)}}" method="post">
                    ...
                    <div class="form-group{{ $errors->has('course_name') ? ' has-error' : '' }}">
                        <label for="course_name" class="col-md-4 control-label">@lang('Название курса')</label>
                    ...
                    <div class="form-group{{ $errors->has('course_time') ? ' has-error' : '' }}">
                        <label for="course_time" class="col-md-4 control-label">@lang('Время курса')</label>
