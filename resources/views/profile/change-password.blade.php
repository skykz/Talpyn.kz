...
@section('title', __('Сменить пароль'))
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="{{url('schools/')}}"><i class="fas fa-arrow-left"></i> @lang('Управление школой')</a>
                </li>
            </ul>
        </div>
        @endif
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="{{url('user/config/change_password')}}" method="post">
                        ...
                        <div class="form-group{{ $errors->has('old_password') ? ' has-error' : '' }}">
                            <label for="old_password" class="col-md-4 control-label">@lang('Старый пароль')</label>
                        ...
                        <div class="form-group{{ $errors->has('new_password') ? ' has-error' : '' }}">
                            <label for="new_password" class="col-md-4 control-label">@lang('Новый пароль')</label>
