    ...
    <div class="row">
        ...
        <div class="col-md-{{ (\Auth::user()->role == 'master')? 12 : 8 }}" id="main-container">
            ...
            <div class="panel panel-default">
                <div class="page-panel-title">@lang('Изменить')</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('edit/user') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">@lang('E-Mail адрес')</label>
                        ...
                        <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}">
                            <label for="department" class="col-md-4 control-label">@lang('Департамент')</label>
                            ...
                            <div class="col-md-6">
                                <select id="class_teacher" class="form-control" name="class_teacher_section_id">
                                    ...
                                    <option value="{{$section->id}}" @if ($section->id == old('class_teacher_section_id', $user->section_id))
											selected="selected"
										@endif
										>@lang('Section'): {{$section->section_number}} @lang('Класс'):
                        ...
                        <div class="form-group{{ $errors->has('group') ? ' has-error' : '' }}">
                            <label for="group" class="col-md-4 control-label">@lang('Группа')</label>

                            <div class="col-md-6">
                                <input id="group" type="text" class="form-control" name="group"
                                    value="{{ $user->studentInfo['group'] }}"
                                    placeholder="@lang('Наука, искусство, коммерция и др.')">
                        ...
                        <div class="form-group{{ $errors->has('father_name') ? ' has-error' : '' }}">
                            <label for="father_name" class="col-md-4 control-label">* @lang('Имя Отца')</label>
                        ...
                        <div class="form-group{{ $errors->has('father_phone_number') ? ' has-error' : '' }}">
                            <label for="father_phone_number" class="col-md-4 control-label">@lang('Номер телефона отца')</label>
...
{{--                            <label for="father_national_id" class="col-md-4 control-label">@lang('Национальное удостоверение личности отца')</label>--}}
...
{{--                            <label for="father_occupation" class="col-md-4 control-label">@lang('Профессия отца')</label>--}}
...
{{--                            <label for="father_designation" class="col-md-4 control-label">@lang('Обозначение отца')</label>--}}
...
{{--                        </div>--}}
                        ...
                        <div class="form-group{{ $errors->has('mother_name') ? ' has-error' : '' }}">
                            <label for="mother_name" class="col-md-4 control-label">* @lang('Имя матери')</label>
                        ...
                        <div class="form-group{{ $errors->has('mother_phone_number') ? ' has-error' : '' }}">
                            <label for="mother_phone_number" class="col-md-4 control-label">@lang('Номер телефона мамы')</label>
...
{{--                        </div>--}}
                        ...
                        <div class="form-group d-flex align-middlejustify-content-center">
                                <a href="{{url('/schools')}}" class="btn btn-danger" style="margin-right: 2%;"
                                    role="button">@lang('Назад')</a>
                                <a type="submit" role="button" class="btn btn-success"><i class="fas fa-save"></i> @lang('Сохранить')</a>
                            </div>
                    </form>
                </div>
            </div>
